 ...
 */
var helloMessage = sayHello("Peter");
 ...
 */
var originalPrice = Number(prompt("What was the total price?"));
var discountAmount = Number(prompt("What was the discount percentage?"));
var discountPercentage = discountAmount * .01;
function applyDiscount() {
    return (originalPrice - (originalPrice * discountPercentage));
}
alert("Your discounted price is " + "$" + applyDiscount().toFixed(2));